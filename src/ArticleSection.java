    ...
    public void setArticles(){
        ...
        switch (articleCategoryNum) {
            case 1 -> {
                ...
                articleTwo = new ArticleImageContainer(new Image("ArticleThumbnails/Q3.png"), "Third Quarter News\nRelease", "Nov 2, 2023", "src/PdfPaths/News Reports/nov0223.pdf",
            ...
            case 2 -> {
                articleOne = new ArticleImageContainer(new Image("ArticleThumbnails/news.png"), "Berkshire Hathaway\nDiversity", "2021", "src/PdfPaths/Sustainability/berkshire2021eeo1.pdf",
            ...
            case 4 -> {
                articleOne = new ArticleImageContainer(new Image("ArticleThumbnails/news.png"), "Comparative Rights", "June 20, 2010", "src/PdfPaths/StockHolderArticles/comparativeRights.pdf", " Comparative Rights and Relative prices of \nBerkshire Class A and Class B Stock");
                articleOneContainer = articleOne.setContainerBehavior();
                articleTwo = new ArticleImageContainer(new Image("ArticleThumbnails/news.png"), "Energy Presentation", "Nov 2022", "src/PdfPaths/StockHolderArticles/BHE2022InvestPresent.pdf", "Presentation shown at EEI annual confernce");
                articleTwoContainer = articleTwo.setContainerBehavior();
                articleThree = new ArticleImageContainer(new Image("ArticleThumbnails/news.png"), "Investment Information", "Feb 17, 2022", "src/PdfPaths/StockHolderArticles/FactsAboutInvesting.pdf", "Important information for investors of Berkshire Hathaway");
                articleThreeContainer = articleThree.setContainerBehavior();
                articleFour = new ArticleImageContainer(new Image("ArticleThumbnails/news.png"), "Stock Holder\n Info", "2022", "src/PdfPaths/StockHolderArticles/commonStock.pdf", "Stock Holder policies and guidelines related to Berkshire Hathaway");
                articleFourContainer = articleFour.setContainerBehavior();
                articleSectionPane.add(articleOneContainer, 0, 0);
                articleSectionPane.add(articleTwoContainer, 1, 0);
                articleSectionPane.add(articleThreeContainer, 0, 1);
