...
public class ArticleContainer extends HBox {
    ...
    public ArticleContainer(Image articleThumbnail, String articleName, String date, String articleFilePath){
